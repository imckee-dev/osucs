...
** Author: Skeleton code creators (Roger or Alex or both)
** Date: Sometime before 11/12/23
** Description: Relatively unchanged, has our functions for displaying what the user wants to do and exwcute each populated-shop function within them.
** Input: n/a
** Output: n/a
*********************************************************************/
