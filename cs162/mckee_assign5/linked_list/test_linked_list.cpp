...
/*********************************************************************
** Program Filename: test_linked_list.cpp
** Author: Skeleton code creator (Alex or Roger probably)
** Date: 12/8/2023
** Description: Has our main function and the pause function to test all of our defined functions in linked_list.cpp, with example lists.
** Input: Nothing
** Output: Console output with test values in linked lists.
*********************************************************************/
